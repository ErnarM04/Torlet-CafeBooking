    ...
    return (
        <div className="w-full flex justify-center bg-[#FAF7F2]">
            <div className="max-w-5xl w-full flex flex-col py-12 px-4 md:px-6 gap-8">
                <p className="text-[#5D4E37] text-3xl text-start">Settings</p>
                ...
                <button className="flex flex-row gap-3 h-15 bg-white border border-[#E8DFD0] rounded-[14px] text-base text-[#5D4E37] items-center justify-center"><LogOut color="#5D4E37" size={18}/>Log Out</button>
            </div>
        </div>
    );
}
